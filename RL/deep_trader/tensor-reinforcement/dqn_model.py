    ...
    for iter in xrange(ITERATION):
        ...
        for episode in xrange(len(data)):
            ...
            for step in xrange(STEP):
                state, action, next_state, reward, done, portfolio, portfolio_value = env_stage_data(agent, step,
                                                                                                     episode_data,
                                                                                                     portfolio,
                                                                                                     portfolio_value,
                                                                                                     True)
            ...
            if episode % 100 == 0 and episode > 10:
                ...
                for i in xrange(10):
                    for step in xrange(STEP):
                        state, action, next_state, reward, done, portfolio, portfolio_value = env_stage_data(agent,
                                                                                                             step,
                                                                                                             episode_data,
                                                                                                             portfolio,
                                                                                                             portfolio_value,
