...
bitcoin_codes = ["USDT_BTC"]

stock_spider_parser = argparse.ArgumentParser()
stock_spider_parser.add_argument("-c", "--codes", default=bitcoin_codes, nargs="+")
stock_spider_parser.add_argument("-s", "--start", default="2019-01-01")
stock_spider_parser.add_argument("-e", "--end", default="2019-05-01")
...
model_launcher_parser.add_argument("-c", "--codes", default=bitcoin_codes, nargs="+")
...
model_launcher_parser.add_argument("--market", default="bitcoin")
