...
def get_intial_data(env):
    init_state, done = env.step_episode_data(1)

    data_dictionary = {}
    data_dictionary["input"] = len(init_state[0]) + 1 #here one is portfolio value
    print("get_initial_data(): input lenghth is ", data_dictionary["input"])
